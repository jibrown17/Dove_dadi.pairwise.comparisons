...
# Load the data
data = dadi.Spectrum.from_file('Dove.RP.MD.spectra.projected.20.15.fs')
...
params = array([0.43321465, 4.71016848, 2.29335257, 1.47923323, 0, 0])
