...
params = array([0.72947222, 0.91610938, 1.75225489, 0])
...
while reps > 0:
    ...
    outfile = "Replicates\Dove.RP.WWD.Sp.NoM"
    pylab.figure(figsize = (8,6))
    dadi.Plotting.plot_2d_comp_multinom(model, data, vmin=0.01, resid_range=1, 
                                        pop_ids =('Rp.Sp.NoM', 'WWD.Sp.NoM'), show = False)
    ...
    file = open("Dove.RP.WWD.Sp.NoM.opt.theta.txt", "a")
