...
#
# Description: Testing a Isolation with NO Migration model
#
#
...
# Load the data
data = dadi.Spectrum.from_file('Dove.Euro.RP.spectra.projected.23.23.fs')
...
params = array([0.1998473, 4.1008621, 0.65784393, 0.56707649, 0, 0])
